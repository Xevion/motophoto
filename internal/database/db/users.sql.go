...
SELECT id, email, password_hash, display_name, role, banned_at, email_verified_at, password_reset_token, password_reset_expires_at, created_at, updated_at FROM users WHERE id = $1 LIMIT 1
`
